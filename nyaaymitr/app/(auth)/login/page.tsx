    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden" style={{ backgroundColor: '#000518' }}>
      ...
      <div className="relative z-20 flex justify-between p-4 md:px-16">
        ...
        <div className="relative">
          ...
          {langOpen && (
            <div className="absolute right-0 z-50 mt-2 w-48 overflow-hidden rounded-xl border shadow-2xl" style={{ backgroundColor: '#0f1e3c', borderColor: 'rgba(255,255,255,0.1)' }}>
              {LANGUAGES.map((lang) => (
                <button
                  type="button"
                  key={lang}
        ...
        >
          ...
          {authMode !== 'email' ? (
            <div className="space-y-3">
              ...
              {authMode === 'phone' ? (
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    className="h-[52px] flex-1 rounded-xl px-4 text-sm outline-none transition-all"
              ...
              <button
                type="button"
                onClick={authMode === 'phone' ? handleSendOtp : handleVerifyOtp}
                disabled={loading}
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                style={{ backgroundColor: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.15)', color: '#f8f9fa' }}
              />
              <label className="block text-xs font-bold uppercase tracking-widest" style={{ color: '#b8c6ed' }}>Password</label>
              <input
                type="password"
          ...
          {status ? <p className="mt-4 rounded-xl bg-white/5 p-3 text-sm" style={{ color: '#b8c6ed' }}>{status}</p> : null}
